...
export function SegmentedControl<T extends string>({
	...
	return (
		<div
			...
			className="flex gap-1 rounded-3 border border-border bg-fill p-1 h-16"
		>
			{options.map((opt) => {
...
export function Stepper({
	...
	return (
		<div className="flex items-center gap-1 rounded-3 border border-border bg-fill p-1 h-16">
			...
			<span className="min-w-6 text-center text-base font-[600] text-ink tabular-nums min-w-24">
				{value}
			</span>
			<button
				type="button"
